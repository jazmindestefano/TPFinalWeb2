                ...
                response.preguntas.forEach(function (pregunta) {
                    let fila = `
                                <tr>
                                    ...
                                    <td>  <a href="/editor/aprobar&id_pregunta={{idPregunta}}"> <button type="submit" class="btn-gral">Aprobar</button></a> 
                                    <a href="/editor/desaprobar&id_pregunta={{idPregunta}}"> <button type="submit" class="btn-gral">desaprobar</button></a>
